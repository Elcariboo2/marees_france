...
- `number.[PORT_NAME]_minimum_depth` — Adjustable minimum depth (if configured)
...
- **Default**: 0 meters
- **Features**:
  - Setting this value will adapt graphics layouts by adding colored 'zones' tazt indicate the time slot to safely leave/enter the port.
